...
class Application(Frame):
	"""GUI application that creates a story based on the user input"""
	...
	def create_widgets(self):
		...
		Label(self, text = "Enter information for a story").grid(row = 0, column = 0, sticky = W)
		...
		Label(self, text = "Body Parts:").grid(row = 5, column = 0, sticky = W)
		...
		body_parts = ["bellybutton", "big toes", "medulla oblongata"]
		column = 1
